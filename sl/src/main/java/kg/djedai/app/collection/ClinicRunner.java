...
public class ClinicRunner{
	...
	public void TestDataInClinic(){
        clinic.addClient(new Client("Rocky", new Dog(new Animal("Bobik"))));
        clinic.addClient(new Client("Nina", new Cat("Rizhik")));
        clinic.addClient(new Client("Monika", new Dog(new Animal("Sharik"))));
        clinic.addClient(new Client("Richard", new Cat("Tom")));
    }
    ...
    public void addTestButton(){
        String answer;
        System.out.println("Хотите добавить пробные даннные? y/n ");
        while(true) {
    ...
    public void addNewClientButton(){
        ...
        if(classPet.equals("cat")){
            ...
            clinic.addClient(new Client(inputClient,cat));
        } else if(classPet.equals("dog")){
            System.out.println("Введите имя собаки: ");
            namePet = this.reader.next();
            Dog dog = new Dog(new Animal(namePet));
            clinic.addClient(new Client(inputClient, dog));
        }
